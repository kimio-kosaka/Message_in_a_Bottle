#include "scroll_msg.h" //by kimio kosaka
// modified line number 976, 995, 1005  by kimio kosaka
...
void initFirmata()
{
  ...
  Firmata.attach(STRING_DATA, stringCallback); // STRING_DATA handler. there is scroll_msg.h  by kimio kosaka
...
void setup()
{
  ...
  init_panel();  // initialize LED panel. there is scroll_msg.h  by kimio kosaka
}
...
void loop()
{
  ...
  disp_panel(); // display and scrolling message. there is scroll_msg.h  by kimio kosaka
