...
char ssid[] = "bottled_circuit";   // <------ Set here
...
#define STATIC_IP_ADDRESS  10,0,0,73      // <------ Set here
#define SUBNET_MASK        255,255,255,0  // <------ Set here 
#define GATEWAY_IP_ADDRESS 10,0,0,1       // <------ Set here       
...
#define SERVER_PORT 3030   // <------ Set here
...
char wpa_passphrase[] = "bottled_circuit";  // <------ Set here
